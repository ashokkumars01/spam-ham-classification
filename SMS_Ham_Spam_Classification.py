...
class pkl:
    ...
    def spam_ham():
        try:
            ...
            pickle.dump(ETC, open(r'C:\Users\prash\Desktop\data\SMS_Spam_Ham_Classification\spam_ham1.pkl','wb'))
        except Exception as e:
            print(e)
            logging.exception(e)
...
class load_model:
    ...
    def pred(self):
        try:
            ...
            model = pickle.load(open(r'C:\Users\prash\Desktop\data\SMS_Spam_Ham_Classification\spam_ham1.pkl','rb'))
            cv = pickle.load(open(r'C:\Users\prash\Desktop\data\SMS_Spam_Ham_Classification\transform1.pkl','rb'))
            data = cv.transform(self.data)
            y_pred = LR.predict(data)
            print(y_pred)
            if y_pred == 0:
